...
This directory contains the central guidelines, proposals, presentations, and technical records for the real-time sound source localization and tracking project.

---

### File registry

| File name | Type | Purpose & core contents |
| :--- | :--- | :--- |
| **`project_description.pdf`** | Reference | Official project guidelines, requirements, and grading criteria provided by the instructor at TUM. |
