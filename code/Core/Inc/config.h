...
#define SETTLING_TIME           1000      // Settling time after actuation [ms]

// Hardware settings
#define SERVO_MIN_ANGLE         0.0f      // Minimum servo angle [rad]
#define SERVO_MAX_ANGLE         PI        // Maximum servo angle [rad]
#define SERVO_MIN_PWM           600       // Equivalent to 500 us with  current tim2 setup      
#define SERVO_MAX_PWM           2400      // Equivalent to 2500 us with current tim2 setup
