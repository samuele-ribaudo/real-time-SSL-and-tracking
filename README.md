...
![Live system demo](documentation/utils/demo.gif)
> Video: Real-time demonstration of the robotic hearing system reacting to finger snaps. ([Download MP4 version](documentation/demo.mp4))
