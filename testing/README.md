...
* `test_main.c`: A test harness that feeds simulated arrays into the DSP functions and asserts if the calculated TDOA (Time Delay of Arrival) matches the expected mathematical shift.
